...
Tento způsob výpočtu byl srovnán s analytickým způsobem výpočtu pro $N=N_p=3$. V obou případech vyšly stejné hodnoty a jejich nejistoty se rovnaly řádem i hodnotou v první platné cifře.
