...
\begin{table}[H]
	...
	\input{rovMer_data/1vysledky_inputData}
\end{table}
\begin{table}[H]
	\centering
	...
	\input{rovMer_data/1vysledky_prutoky}
\end{table}
\begin{table}[H]
	\centering
...
\begin{table}[H]
	\centering
	\caption{Průměrné koncentrace radonu v daném podlaží a objemy všech místností v daném podlaží.}
	\input{rovMer_data/2vysledky_inputData}
\end{table}
\begin{table}[H]
	\centering
	\caption{Průtoky vzduchu mezi podlažími v \si{m^3/hod}. Hodnota v $i$-tém řádku a $j$-tém sloupci představuje průtok vzduchu z $i$-tého podlaží do $j$-tého podlaží. Poslední sloupec představuje exfiltrace z jednotlivých podlaží do vnějšího prostředí a poslední řádek představuje infiltrace z vnějšího prostředí do jednotlivých zón.}
	\input{rovMer_data/2vysledky_prutoky}
\end{table}
\begin{table}[H]
	\centering
	\caption{Výsledné přísuny radonu pro několik případů koncentrací radonu ve vnějším prostředí. $Q_i$ značí přísun radonu do $i$-tého podlaží.}
    \label{tab:rovMer_Q_2}
	\input{rovMer_data/2vysledky_Q}
\end{table}
...
\begin{table}[H]
	\centering
	\caption{Průměrné koncentrace radonu v daném podlaží a objemy všech místností v daném podlaží.}
	\input{rovMer_data/3vysledky_inputData}
\end{table}
\begin{table}[H]
	\centering
	\caption{Průtoky vzduchu mezi podlažími v \si{m^3/hod}. Hodnota v $i$-tém řádku a $j$-tém sloupci představuje průtok vzduchu z $i$-tého podlaží do $j$-tého podlaží. Poslední sloupec představuje exfiltrace z jednotlivých podlaží do vnějšího prostředí a poslední řádek představuje infiltrace z vnějšího prostředí do jednotlivých zón.}
	\input{rovMer_data/3vysledky_prutoky}
\end{table}
\begin{table}[H]
	\centering
	\caption{Výsledné přísuny radonu pro několik případů koncentrací radonu ve vnějším prostředí. $Q_i$ značí přísun radonu do $i$-tého podlaží.}
    \label{tab:rovMer_Q_3}
	\input{rovMer_data/3vysledky_Q}
\end{table}
...
\begin{table}[H]
	\centering
	\caption{Průměrné koncentrace radonu v daném podlaží a objemy všech místností v daném podlaží.}
	\input{rovMer_data/4vysledky_inputData}
\end{table}
\begin{table}[H]
	\centering
	\caption{Průtoky vzduchu mezi podlažími v \si{m^3/hod}. Hodnota v $i$-tém řádku a $j$-tém sloupci představuje průtok vzduchu z $i$-tého podlaží do $j$-tého podlaží. Poslední sloupec představuje exfiltrace z jednotlivých podlaží do vnějšího prostředí a poslední řádek představuje infiltrace z vnějšího prostředí do jednotlivých zón.}
	\input{rovMer_data/4vysledky_prutoky}
\end{table}
\begin{table}[H]
	\centering
	\caption{Výsledné přísuny radonu pro několik případů koncentrací radonu ve vnějším prostředí. $Q_i$ značí přísun radonu do $i$-tého podlaží.}
    \label{tab:rovMer_Q_4}
	\input{rovMer_data/4vysledky_Q}
\end{table}
...
\begin{table}[H]
	...
	\input{rovMer_data/8vysledky_inputData}
\end{table}
\begin{table}[H]
	\centering
	\caption{Průtoky vzduchu mezi podlažími v \si{m^3/hod}. Hodnota v $i$-tém řádku a $j$-tém sloupci představuje průtok vzduchu z $i$-tého podlaží do $j$-tého podlaží. Poslední sloupec představuje exfiltrace z jednotlivých podlaží do vnějšího prostředí a poslední řádek představuje infiltrace z vnějšího prostředí do jednotlivých zón.}
    \label{tab:rovMer_prutoky_8}
	\input{rovMer_data/8vysledky_prutoky}
\end{table}
\begin{table}[H]
	\centering
	\caption{Výsledné přísuny radonu pro několik případů koncentrací radonu ve vnějším prostředí. $Q_i$ značí přísun radonu do $i$-tého podlaží.}
    \label{tab:rovMer_Q_8}
	\input{rovMer_data/8vysledky_Q}
\end{table}
