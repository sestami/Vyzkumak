...
\begin{table}[H]
   ...
   \input{skala75/vysledky_Q_dynamicky}
\end{table}
...
\begin{table}[H]
   ...
   \input{skala75/vysledky_Q_rovnovazne}
\end{table}
...
\begin{table}[H]
   ...
   \input{skala75/vysledky_Q_rovnovazneCANARY}
\end{table}
...
\begin{table}[H]
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{skala75/zpetnyChod_prutoky1}
    \end{subtable}
    %\vspace{1em}
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{skala75/zpetnyChod_prutoky2}
    \end{subtable}
    %\vspace{1em}
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{skala75/zpetnyChod_prutoky3}
    \end{subtable}
\end{table}
...
%\begin{table}[H]
    ...
    %\input{halkova980/vysledky_Q_statistiky}
%\end{table}
\begin{table}[H]
    \centering
    ...
    \input{halkova980/vysledky_Q_rovnovazne}
\end{table}
...
\begin{table}[H]
    ...
    \input{halkova980/vysledky_Q_rovnovazneCANARY}
\end{table}
...
\begin{table}[H]
    ...
    \input{halkova980/vysledky_OAR.tex}
\end{table}
...
\begin{table}[H]
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{halkova980/zpetnyChod_prutoky1}
    \end{subtable}
    \vspace{1em}
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{halkova980/zpetnyChod_prutoky2}
    \end{subtable}
    \vspace{1em}
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{halkova980/zpetnyChod_prutoky3}
    \end{subtable}

    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{halkova980/zpetnyChod_prutoky4}
    \end{subtable}
\end{table}

\subsection{Diskuze}
Dost informací uvedených u předchozího měření v objektu Skála 75 platí i zde:
\begin{itemize}
...
Při zpětném ověření OAR vyšly hodnoty blízké naměřeným hodnotám (tab.~\ref{tab:halkova980_OAR_zpetne}). Při zpětném ověření průtoků vyšly nominální hodnoty průtoků značně rozdílně oproti $k_{ij}$ z měření, avšak jejich intervaly nejistot jsou tak veliké, že v nich $k_{ij}$ leží. 
...
\subsection{Závěr}
Byly určeny přísuny radonu do obývacího pokoje, ložnice, koupelny s WC a do kuchyně. Jako přesnější jsou opět brány přísuny radonu, při jejichž výpočtu byly použity OAR z CANARY měřáků. Při vyhodnocování byly uvažovány dvě kombinace tracerů, jako přesnější byla vyhodnocena kombinace (MDC, MCH, TCE, TMH). Vypočítané a vybrané $Q_i$ se shoduje s $Q_{zdroj}$, avšak mají obrovskou nejistotu.

Hlavním zdrojem nejistot tohoto měření bylo umístění příliš mnoho vyvíječů do zón, což vedlo k saturaci několika TD detektorů.
...
\begin{table}[H]
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{anglicka574/zpetnyChod_prutoky1}
    \end{subtable}
    \vspace{1em}
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{anglicka574/zpetnyChod_prutoky2}
    \end{subtable}
    \vspace{1em}
    ...
    \begin{subtable}{\textwidth}
        \centering
        \caption{}
        \input{anglicka574/zpetnyChod_prutoky3}
    \end{subtable}
\end{table}
