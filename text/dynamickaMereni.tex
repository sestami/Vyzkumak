...
Objemy všech objektů byly změřeny laserovým dálkoměrem BOSCH GLM 120 C~\cite{dalkomer} a jejich relativní nejistota byla odhadnuta na 20~\%.
...
\begin{itemize}
    ...
    \item dále bylo použito osm kombinací trojic indikačních plynů, z nichž se určovaly odezvy TD detektorů a odpary z vyvíječů pro určení osmi variant $k_{ij}$, tj. z toho máme osm variant $Q_i$.
\end{itemize}
