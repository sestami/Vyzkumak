...
poc='2019-05-24 13:00'
kon='2019-06-05 11:00'
...
OAR4=plotovani(data4, 'přízemí ložnice')
OAR3=plotovani(data3, 'první patro')
...
OAR_means=np.array([OAR1.mean(), OAR2.mean(), OAR4.mean(), OAR3.mean()])
