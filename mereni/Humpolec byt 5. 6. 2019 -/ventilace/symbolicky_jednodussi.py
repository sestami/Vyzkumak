...
pocatek=datetime.datetime(2019, 6, 5, 12, 00)
konec=datetime.datetime(2019, 6, 20, 10, 45)
...
M_hodnoty=odpary/dT
M_hodnoty=completion(M_hodnoty, M_hodnoty*M_err)
...
prutoky_hodnoty.to_csv('airflows1_sym.txt', sep=';', decimal=',', float_format='%.8f')
