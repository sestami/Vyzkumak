...
def citlivost(data):
    return (data.loc[:, 'sum2']+data.loc[:, 'sum3'])/data.loc[:, 'radon[Bq/m3]']

citlivost8=citlivost(data8)
citlivost10=citlivost(data10)
citlivost88=citlivost(data88)
citlivost112=citlivost(data112)
